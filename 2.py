...
M.Wall(X=0, Y=0, Z=108, A=0, L=230, H=96)
M.Wall(X=230, Y=0, Z=108, A=90, L=230, H=96, StartOffset=True, EndOffset=True)
M.Wall(X=230, Y=230, Z=108, A=180, L=230, H=96)
M.Wall(X=0, Y=230, Z=108, A=270, L=230, H=96, StartOffset=True, EndOffset=True)
